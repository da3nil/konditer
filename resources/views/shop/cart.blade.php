...
@section('content')
    ...
    <div>
        ...
        <div class="card p-0 w-100">
            <div class="card-header w-100"><h1 class="d-inline">Корзина</h1><button class="btn btn-primary pull-right" data-toggle="modal" data-target="#exampleModal">Оформить заказ</button></div>
                ...
                @if (count(Cart::content()))
                    <table class="table">
                        ...
                        <tr>
                            ...
                            <th style="max-width: 10%; width: 10%" class="border-top-0" scope="col">Удалить</th>
                        </tr>
                        </thead>
                        <tbody>
                    ...
                    <div class="modal-body w-100">
                        @auth
                            <div class="form-group w-100 p-0 mb-3">
                                ...
                                <input name="user_name" id="or1" type="text" class="form-control m-0 w-100" style="color: #000000" value="{{ Auth::user()->name }}">
                            </div>
                            <div class="form-group w-100 p-0 mb-3">
                                <label for="or2">Email</label>
                                <input name="user_email" id="or2" type="email" class="form-control m-0 w-100" style="color: #000000" value="{{ Auth::user()->email }}">
                            </div>
                            <div class="form-group w-100 p-0 mb-3">
                                <label for="or3">Адрес</label>
                                <input name="user_address" id="or3" type="text" class="form-control m-0 w-100" style="color: #000000">
                            </div>
                            <div class="form-group w-100 p-0 mb-3">
                                <label for="or4">Телефон</label>
                                <input name="user_phone" id="or4" type="tel" class="form-control m-0 w-100" style="color: #000000">
                            </div>
                        @else
                            <h3 class="text-center"><a style="color: #84284d;" href="{{ route('login') }}">Для оформления заказа необходимо <u>авторизоваться</u></a></h3>
                        @endauth
                    </div>

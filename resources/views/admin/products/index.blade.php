                                ...
                                <div class="col-sm-12">
                                    <table id="example2" class="table table-bordered dataTable mytable" role="grid"
                                        ...
                                        <tr role="row">
                                            ...
                                            <th class="sorting_asc d-none-phone" tabindex="0" aria-controls="example2" rowspan="1"
                                                colspan="1" aria-sort="ascending"
                                                aria-label="Rendering engine: activate to sort column descending">
                                                Категория
                                            </th>
                                        ...
                                        @foreach($data as $item)
                                            <tr role="row" class="odd">
                                                ...
                                                <td class="d-none-phone">{{ $item->shopCategory->name }}</td>
                                        ...
                                        <tr>
                                            ...
                                            <th class="d-none-phone" rowspan="1" colspan="1">Категория</th>
